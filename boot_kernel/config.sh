...
export TINYSH="$BUILDDIR/tinysh/tinysh"
export INITRAMFS="$OUTPUT/initramfs.cpio.gz"
export INITRAMFS_TINY="$OUTPUT/initramfs-tiny.cpio.gz"
...
export QEMU_APPEND="${QEMU_APPEND:-console=ttyS0 rdinit=/init panic=1}"
export QEMU_APPEND_TINY="${QEMU_APPEND_TINY:-console=ttyS0 rdinit=/bin/tinysh panic=1}"
